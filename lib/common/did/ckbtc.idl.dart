...
class CkbtcIDLActor {
  const CkbtcIDLActor._();

  /// ```Candid
  ///   http_request: (HttpRequest) -> (HttpResponse) query
  /// ```
  static Future<HttpResponse> httpRequest(
    CanisterActor actor,
    HttpRequest arg,
  ) async {
    final dat = [arg];
    final ret = await actor.getFunc('http_request')!(dat);
    return HttpResponse.fromJson(ret);
  }
...
class CkbtcIDLService {
  ...
  Future<HttpResponse> httpRequest(
    ...
    return CkbtcIDLActor.httpRequest(
      actor,
      arg,
    );
  }
  ...
  Future<BigInt> icrc1BalanceOf(
    ...
    final actor = await getActor();
    return CkbtcIDLActor.icrc1BalanceOf(
      actor,
      arg,
    );
  }
  ...
  Future<int> icrc1Decimals() async {
    final actor = await getActor();
    return CkbtcIDLActor.icrc1Decimals(
      actor,
    );
  }
  ...
  Future<List<Icrc1MetadataRet0Item>> icrc1Metadata() async {
    final actor = await getActor();
    return CkbtcIDLActor.icrc1Metadata(
      actor,
    );
  }
  ...
  Future<Account?> icrc1MintingAccount() async {
    final actor = await getActor();
    return CkbtcIDLActor.icrc1MintingAccount(
      actor,
    );
  }
  ...
  Future<String> icrc1Name() async {
    final actor = await getActor();
    return CkbtcIDLActor.icrc1Name(
      actor,
    );
  }
  ...
  Future<List<StandardRecord>> icrc1SupportedStandards() async {
    final actor = await getActor();
    return CkbtcIDLActor.icrc1SupportedStandards(
      actor,
    );
  }
  ...
  Future<String> icrc1Symbol() async {
    final actor = await getActor();
    return CkbtcIDLActor.icrc1Symbol(
      actor,
    );
  }
  ...
  Future<BigInt> icrc1TotalSupply() async {
    final actor = await getActor();
    return CkbtcIDLActor.icrc1TotalSupply(
      actor,
    );
  }
  ...
  Future<Result> icrc1Transfer(
    ...
    final actor = await getActor();
    return CkbtcIDLActor.icrc1Transfer(
      actor,
      arg,
    );
  }
...
class CkbtcIDL {
  ...
  /// [_HttpRequest] defined in Candid
  /// ```Candid
  ///   type HttpRequest = record { url: text; method: text; body: vec nat8; headers: vec record { text; text } };
  /// ```
  static final RecordClass _HttpRequest = IDL.Record({
    'url': IDL.Text,
    'method': IDL.Text,
    'body': IDL.Vec(
      IDL.Nat8,
  ...
  /// [_HttpResponse] defined in Candid
  /// ```Candid
  ///   type HttpResponse = record { body: vec nat8; headers: vec record { text; text }; status_code: nat16 };
  /// ```
  static final RecordClass _HttpResponse = IDL.Record({
    'body': IDL.Vec(
      IDL.Nat8,
    ),
    'headers': IDL.Vec(
...
/// [HttpRequestHeadersItem] defined in Candid
/// ```Candid
///   record { text; text }
/// ```
@immutable
class HttpRequestHeadersItem {
  const HttpRequestHeadersItem(
    this.item1,
    this.item2,
  );

  factory HttpRequestHeadersItem.fromJson(List<dynamic> tuple) {
    return HttpRequestHeadersItem(
      tuple[0],
      tuple[1],
    );
  }
  ...
  HttpRequestHeadersItem copyWith({
    /// [item1] defined in Candid: `text`
    String? item1,
  ...
  bool operator ==(dynamic other) {
    return identical(this, other) ||
        (other.runtimeType == runtimeType &&
            other is HttpRequestHeadersItem &&
            (identical(other.item1, item1) || other.item1 == item1) &&
            (identical(other.item2, item2) || other.item2 == item2));
  }
...
/// [HttpResponseHeadersItem] defined in Candid
/// ```Candid
///   record { text; text }
/// ```
typedef HttpResponseHeadersItem = HttpRequestHeadersItem;

/// [HttpRequest] defined in Candid
/// ```Candid
///   record { url: text; method: text; body: vec nat8; headers: vec record { text; text } }
/// ```
@immutable
class HttpRequest {
  const HttpRequest({
    ...
    /// [method] defined in Candid: `method: text`
    required this.method,

    /// [body] defined in Candid: `body: vec nat8`
    required this.body,

    /// [headers] defined in Candid: `headers: vec record { text; text }`
  ...
  factory HttpRequest.fromJson(Map json) {
    return HttpRequest(
      ...
      method: json['method'],
      body: json['body'],
      headers: (json['headers'] as List).map((e) {
        return HttpRequestHeadersItem(
          e[0],
          e[1],
        );
  ...
  /// [headers] defined in Candid: `headers: vec record { text; text }`
  final List<HttpRequestHeadersItem> headers;
  ...
  HttpRequest copyWith({
    ...
    /// [headers] defined in Candid: `headers: vec record { text; text }`
    List<HttpRequestHeadersItem>? headers,
  }) {
    return HttpRequest(
      url: url ?? this.url,
...
/// [HttpResponse] defined in Candid
/// ```Candid
///   record { body: vec nat8; headers: vec record { text; text }; status_code: nat16 }
/// ```
@immutable
class HttpResponse {
  const HttpResponse({
    ...
    /// [statusCode] defined in Candid: `status_code: nat16`
  ...
  factory HttpResponse.fromJson(Map json) {
    return HttpResponse(
      body: json['body'],
      headers: (json['headers'] as List).map((e) {
        return HttpResponseHeadersItem(
          e[0],
          e[1],
        );
      }).toList(),
  ...
  /// [headers] defined in Candid: `headers: vec record { text; text }`
  final List<HttpResponseHeadersItem> headers;
  ...
  HttpResponse copyWith({
    ...
    /// [headers] defined in Candid: `headers: vec record { text; text }`
    List<HttpResponseHeadersItem>? headers,
